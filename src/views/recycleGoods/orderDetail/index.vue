          ...
          <el-row>
            ...
            <el-col :span="18">
              <div @click="handleClickWatch(orderObj.alipayName, '1')" class="hidden-btn">
                <span
                  v-if="!isHiddenObj.isShowAlipayName"
                >{{orderObj.alipayName? '******' : orderObj.alipayName}}</span>
          ...
          <el-row>
            ...
            <el-col :span="18">
              <div @click="handleClickWatch(orderObj.alipayAccount, '2')" class="hidden-btn">
                <span
                  v-if="!isHiddenObj.isShowAlipayAccount"
                >{{orderObj.alipayAccount? '******' : orderObj.alipayAccount}}</span>
          ...
          <el-row>
            ...
            <el-col :span="18">
              <div @click="handleClickWatch(orderObj.userPhone, '3')" class="hidden-btn">
                <span
                  v-if="!isHiddenObj.isShowUserPhone"
                >{{orderObj.userPhone? '******' : orderObj.userPhone}}</span>
          ...
          <el-row>
            ...
            <el-col :span="18">
              <div @click="handleClickWatch(orderObj.userName, '4')" class="hidden-btn">
                <span
                  v-if="!isHiddenObj.isShowUserName"
                >{{orderObj.userName ? '******' : orderObj.userName}}</span>
